...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Man & Tech — Digital Product Studio" },
      {
        name: "description",
        content:
          "Man & Tech is a digital product studio building websites, applications, SaaS and AI-powered solutions.",
      },
      { name: "author", content: "Man & Tech" },
      { property: "og:site_name", content: "Man & Tech" },
